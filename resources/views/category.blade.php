...
<div class="grid grid-cols-1 md:grid-cols-3">
    ...
    <div class="p-8">
        ...
        <h2 class="uppercase mt-6 text-indigo-500 font-medium mb-3"> {{ $sponsor->title }} </h2>
        <p class="font-light text-sm text-gray-500 mb-3"> {{ $sponsor->body }} </p> <a class="text-indigo-500 flex items-center hover:text-indigo-600" href="/sponsors/{{ $sponsor->slug }}"> Selengkapnya
