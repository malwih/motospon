...
@endif
    ...
    <tbody class="bg-white divide-y divide-gray-200">
        ...
        <tr>
            ...
            <td class="px-6 py-4 text-center">{{ $proposal->sponsor->title ?? 'N/A' }}</td>
...
<td class="px-4 py-3 text-center">
    <div class="relative inline-block text-left" x-data="{ open: false }">
        ...
        <div x-show="open" @click.away="open = false"
            ...
            <a href="{{ route('proposal.edit', $proposal->id) }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Edit</a>
