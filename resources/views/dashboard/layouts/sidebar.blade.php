                ...
                <li>
                    ...
                    <li>
                        <a href="/dashboard/products" 
                           class="flex items-center space-x-3 p-2 rounded-md font-medium
                           {{ Request::is('dashboard/products*') ? 'bg-orange-500 text-white' : 'text-gray-700 hover:bg-orange-500 hover:text-white' }}">
                            <svg class="h-5 w-5 {{ Request::is('dashboard/products*') ? 'text-white' : 'text-gray-600' }}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
