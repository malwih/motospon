...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="text-3xl font-bold text-black mb-6">Create New Product</h1>
</div>
<div class="col-lg-8">
  <form method="post" action="/dashboard/products" class="mb-5" enctype="multipart/form-data">
    @csrf
    <div class="max-w-sm mb-3">
      <label for="title" class="form-label block mb-2 text-large font-medium text-gray-900 dark:text-black">Name Product</label>
    ...
    <div class="mb-3">
      <label for="body" class="form-label block mb-2 text-large font-medium text-gray-900 dark:text-black">Description</label>
      @error('body')
    ...
    <button type="submit" class="text-white bg-orange-500 hover:bg-orange-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Create Product</button>
  </form>
</div>
    </div>
</div>
