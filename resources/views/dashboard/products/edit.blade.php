...
<div class="p-10 sm:ml-64">
  <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-20">
        ...
        <div class="col-lg-8">
            <form method="post" action="/dashboard/sponsors/{{ $sponsor->slug }}" class="mb-5" enctype="multipart/form-data">
                @method('put')
                @csrf
                ...
                <div class="mb-3">
                    ...
                    @if($sponsor->image)
                    <img src="{{ asset('storage/' . $sponsor->image) }}" class="w-1/2 h-1/2 img-preview img-fluid mb-3 mt-3 col-sm-5 d-block">
                    @else
