...
<div class="p-10 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-20">
        ...
        <a href="/dashboard/products/create" class="text-white bg-orange-500 hover:bg-orange-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Create New Product</a>
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-100 dark:border-gray-700">
                        ...
                        <td class="flex col-lg-8 mt-5">
                            <a href="/dashboard/products/{{ $product->slug }}"><span data-feather="eye" class="bg-green-600 hover:bg-green-700 text-white font-bold py-1 px-1 rounded"></span></a>
                            <a href="/dashboard/products/{{ $product->slug }}/edit"><span data-feather="edit" class="ml-2 mr-2 bg-yellow-600 hover:bg-yellow-700 text-white font-bold py-1 px-1 rounded"></span></a>
