...
<div class="p-10 sm:ml-80">
    <div class="bg-white shadow-lg rounded-lg p-8 max-w-4xl mx-auto mt-24 font-sans text-gray-800 leading-relaxed">
        ...
        <form id="submitForm" action="{{ route('proposals.submit') }}" method="POST">
            ...
            {{-- Submit Button --}}
            <button type="submit"
                class="block w-full mt-4 py-3 rounded-2xl text-center bg-green-500 text-white font-semibold hover:bg-green-600 transition duration-300">
                Submit
            </button>
        </form>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        form.addEventListener('submit', function (e) {
            ...
            Swal.fire({
                title: 'Berhasil!',
                text: 'Proposal berhasil disubmit.',
                icon: 'success',
