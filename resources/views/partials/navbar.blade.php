...
{{-- ============================================================ --}}
{{--
    Komponen navbar untuk tampilan utama
    - Posisi fixed di bagian atas halaman
    - Berisi logo, menu navigasi, dan menu user
    - Responsif dengan tampilan mobile dan desktop
--}}
<header class="fixed w-full z-20 top-0 left-0 border-b bg-white shadow-lg h-14 flex items-center px-4 md:px-8">
  ...
  <a href="/" class="flex-shrink-0 flex items-center">
    ...
    {{--
        ...
        - Warna oranye konsisten dengan tema
        - Spasi antar menu
    --}}
    ...
    <a href="/sponsorships" class="px-3 py-3 hover:bg-gray-300 rounded {{ request()->is('sponsorships') || request()->is('sponsorships/*') ? 'bg-gray-300' : '' }}">Sponsorship</a>
  </nav>

    {{-- ============================================================ --}}
    {{-- MENU USER & MOBILE BUTTON --}}
    {{-- ============================================================ --}}
    {{--
        Container untuk menu user dan tombol mobile
        - Posisi di kanan navbar (ml-auto)
    ...
    {{-- ============================================================ --}}
    {{--
        Dropdown menu untuk aksi user
        - Menampilkan nama user
        - Berisi menu dashboard dan logout
        - Posisi absolute di bawah tombol
    --}}
    <div class="relative">
    ...
    {{-- ============================================================ --}}
    {{--
        Tombol untuk menampilkan menu di mobile
        - Hanya terlihat di layar kecil (md:hidden)
        - Menggunakan ikon hamburger
        - Aksesibilitas dengan aria-* attributes
    --}}
...
{{--
    ...
    - Muncul saat tombol menu diklik
    - Posisi fixed di bawah navbar
    - Lebar penuh dengan scroll jika perlu
--}}
<nav id="mobileMenu" class="hidden md:hidden fixed top-14 left-0 w-full bg-white border-b shadow-lg z-30">
  <ul class="flex flex-col text-orange-500 font-semibold text-base">
    <li><a href="/" class="block px-4 py-3 hover:bg-gray-300">Home</a></li>
    <li><a href="/sponsorships" class="block px-4 py-3 hover:bg-gray-300 {{ request()->is('sponsorships') ? 'bg-gray-300' : '' }}">Sponsors</a></li>
...
{{-- ============================================================ --}}
{{--
    Script untuk mengatur interaksi navbar
...
<script>
  ...
  // TOGGLE DROPDOWN MENU USER
  // ============================================================
  // Mengatur tampilan dropdown menu user saat tombol diklik
  ...
  // TOGGLE MENU MOBILE
  // ============================================================
  // Mengatur tampilan menu mobile dan status aria-expanded
  ...
  // CLOSE DROPDOWN SAAT KLIK DI LUAR
  // ============================================================
  // Menutup dropdown/menu mobile saat user mengklik di luarnya
