...
@section('container')
    <!-- Header -->
    <div class="bg-gradient-to-tr from-orange-300 to-orange-200 pt-20 pb-6">
        <h2 class="text-center text-3xl font-bold text-orange-600">Sponsorship</h2>
    </div>
        ...
        <div class="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto">
            ...
            @forelse ($sponsors as $sponsor)
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:scale-105 transition-transform duration-300">
                    ...
                    <div class="p-5">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">{{ $sponsor->title }}</h3>
                        <div class="space-y-2 text-sm text-gray-600">
                            <div class="flex items-start gap-2">
                                ...
                                <p>{{ Str::words(strip_tags($sponsor->body), 15, '...') }}</p>
                            </div>
                            <div class="flex items-start gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-indigo-600" fill="none"
                                     viewBox="0 0 24 24" stroke="currentColor">
    ...
    <button
        class="mt-4 w-full bg-orange-500 hover:bg-orange-700 text-white py-2 rounded-xl shadow-md transition duration-300">
        Lihat Detail
    </button>
</a>
